...
const LatestUserReview = () => {
  ...
  useEffect(() => {
    axiosPublic("/all-user/review").then((res) => {
  ...
  return (
    <div>
      <div className="">
        <section className="shadow-lg shadow-gray-400 ">
          <div className="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
            ...
            <div className="mt-8 grid grid-cols-1  gap-4 md:grid-cols-3 md:gap-8">
              {review.map((review) => (
                <blockquote
                  key={review._id}
                  className="rounded-lg p-6 shadow-sm sm:p-8 shadow-lg shadow-green-500/50"
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="mt-0.5 text-lg font-medium text-gray-500">
                        {review.user_name}
                      </p>
                    </div>
                  </div>
